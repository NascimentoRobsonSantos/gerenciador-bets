              ...
              <div key={e.id} className="p-3 rounded-lg border border-neutral-800 bg-neutral-900/20">
                ...
                <div className="mt-2 overflow-x-auto">
                  <div className="flex items-stretch gap-2 text-xs">
                    ...
                    <div className={`min-w-[84px] rounded border border-neutral-800 p-2 ${isGreen ? 'bg-b365-green/15' : isRed ? 'bg-red-500/15' : 'bg-neutral-900/40'}`}>
                    ...
                    <div className={`min-w-[84px] rounded border border-neutral-800 p-2 ${finalVal > 0 ? 'bg-b365-green/15' : finalVal < 0 ? 'bg-red-500/15' : 'bg-neutral-900/40'}`}>
